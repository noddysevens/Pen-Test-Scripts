...
if [ "$#" != "2" ]; then
	echo "Breach-Parse v2: A Breached Domain Parsing Tool by The Cyber Mentor"
	echo " " 
	...
	touch $master
	total_files=$(find /media/david/Data/BreachCompilation/data -type f | wc -l)
	file_count=0
	...
	find /media/david/Data/BreachCompilation/data -type f -print0 | while read -d $'\0' file
